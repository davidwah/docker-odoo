...
class UploadWizard(models.TransientModel):
	...
	upload = fields.Binary(string="Import Excel Autodebet")
	...
	def convert_data(self):
		...
		#MAKE NEW FILE
		file_name = '/home/anugerah/Documents/odoo-addons/anugrah_school_converter/uploads/file_upload.xlsx'
		...
		self.download_name = 'Export Pemasukan.xlsx'
